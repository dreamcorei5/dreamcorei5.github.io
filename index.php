        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-8 col-md-7 py-4">
              ...
              <p class="text-white">ผมเป็นนักพัฒนาเว็บไซต์ ที่มีประสบการณ์การทำงานในบริษัทซอฟต์แวร์ มากกว่า 5 ปี เชี่ยวชาญในการวิเคราะห์ระบบและพัฒนาเว็บไซต์ตามที่ต้องการ</p>
            </div>
      ...
      <section class="py-5 text-center container">
        <div class="row py-lg-2">
          <div class="col-lg-6 col-md-8 mx-auto">
            <img src="assets/img/profile.jpg" class="img-fluid rounded" style="width: 200px; height: 200px; object-fit: cover;">
            <h1 class="fw-light">Khunathron Thongnopphakhun</h1>
            <p class="lead text-muted">ผมเป็นนักพัฒนาเว็บไซต์ ที่มีประสบการณ์การทำงานในบริษัทซอฟต์แวร์ มากกว่า 5 ปี เชี่ยวชาญในการวิเคราะห์ระบบและพัฒนาเว็บไซต์ตามที่ต้องการ</p>
            <p>portfolio</p>
          </div>
        </div>
      </section>
